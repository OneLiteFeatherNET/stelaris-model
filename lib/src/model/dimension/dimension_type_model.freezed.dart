...
mixin _$DimensionTypeModel {
 ...
 String get uiName; String? get id; String? get projectId; String? get key; bool get hasFixedTime; bool get hasSkylight; bool get hasCeiling; bool get hasEnderDragonFight; double? get coordinateScale; int? get minY; int? get height; int? get logicalHeight; String? get infiniburn; double? get ambientLight; String? get monsterSpawnLightLevel; int? get monsterSpawnBlockLightLimit; Skybox? get skybox; CardinalLight? get cardinalLight; String? get defaultClock; List<DimensionAttributeDto> get attributes; List<DimensionTimelineDto> get timelines; DateTime? get creationDate; DateTime? get modificationDate;
...
int get hashCode {
  final _this = this as DimensionTypeModel;
  return Object.hashAll([runtimeType,_this.uiName,_this.id,_this.projectId,_this.key,_this.hasFixedTime,_this.hasSkylight,_this.hasCeiling,_this.hasEnderDragonFight,_this.coordinateScale,_this.minY,_this.height,_this.logicalHeight,_this.infiniburn,_this.ambientLight,_this.monsterSpawnLightLevel,_this.monsterSpawnBlockLightLimit,_this.skybox,_this.cardinalLight,_this.defaultClock,const DeepCollectionEquality().hash(_this.attributes),const DeepCollectionEquality().hash(_this.timelines),_this.creationDate,_this.modificationDate]);
}

@override
String toString() {
  final _this = this as DimensionTypeModel;
  return 'DimensionTypeModel(uiName: ${_this.uiName}, id: ${_this.id}, projectId: ${_this.projectId}, key: ${_this.key}, hasFixedTime: ${_this.hasFixedTime}, hasSkylight: ${_this.hasSkylight}, hasCeiling: ${_this.hasCeiling}, hasEnderDragonFight: ${_this.hasEnderDragonFight}, coordinateScale: ${_this.coordinateScale}, minY: ${_this.minY}, height: ${_this.height}, logicalHeight: ${_this.logicalHeight}, infiniburn: ${_this.infiniburn}, ambientLight: ${_this.ambientLight}, monsterSpawnLightLevel: ${_this.monsterSpawnLightLevel}, monsterSpawnBlockLightLimit: ${_this.monsterSpawnBlockLightLimit}, skybox: ${_this.skybox}, cardinalLight: ${_this.cardinalLight}, defaultClock: ${_this.defaultClock}, attributes: ${_this.attributes}, timelines: ${_this.timelines}, creationDate: ${_this.creationDate}, modificationDate: ${_this.modificationDate})';
}
...
/// Create a copy of DimensionTypeModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uiName = null,Object? id = freezed,Object? projectId = freezed,Object? key = freezed,Object? hasFixedTime = null,Object? hasSkylight = null,Object? hasCeiling = null,Object? hasEnderDragonFight = null,Object? coordinateScale = freezed,Object? minY = freezed,Object? height = freezed,Object? logicalHeight = freezed,Object? infiniburn = freezed,Object? ambientLight = freezed,Object? monsterSpawnLightLevel = freezed,Object? monsterSpawnBlockLightLimit = freezed,Object? skybox = freezed,Object? cardinalLight = freezed,Object? defaultClock = freezed,Object? attributes = null,Object? timelines = null,Object? creationDate = freezed,Object? modificationDate = freezed,}) {
...
as List<DimensionTimelineDto>,creationDate: freezed == creationDate ? _self.creationDate : creationDate // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String uiName,  String? id,  String? projectId,  String? key,  bool hasFixedTime,  bool hasSkylight,  bool hasCeiling,  bool hasEnderDragonFight,  double? coordinateScale,  int? minY,  int? height,  int? logicalHeight,  String? infiniburn,  double? ambientLight,  String? monsterSpawnLightLevel,  int? monsterSpawnBlockLightLimit,  Skybox? skybox,  CardinalLight? cardinalLight,  String? defaultClock,  List<DimensionAttributeDto> attributes,  List<DimensionTimelineDto> timelines,  DateTime? creationDate,  DateTime? modificationDate)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DimensionTypeModel() when $default != null:
return $default(_that.uiName,_that.id,_that.projectId,_that.key,_that.hasFixedTime,_that.hasSkylight,_that.hasCeiling,_that.hasEnderDragonFight,_that.coordinateScale,_that.minY,_that.height,_that.logicalHeight,_that.infiniburn,_that.ambientLight,_that.monsterSpawnLightLevel,_that.monsterSpawnBlockLightLimit,_that.skybox,_that.cardinalLight,_that.defaultClock,_that.attributes,_that.timelines,_that.creationDate,_that.modificationDate);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String uiName,  String? id,  String? projectId,  String? key,  bool hasFixedTime,  bool hasSkylight,  bool hasCeiling,  bool hasEnderDragonFight,  double? coordinateScale,  int? minY,  int? height,  int? logicalHeight,  String? infiniburn,  double? ambientLight,  String? monsterSpawnLightLevel,  int? monsterSpawnBlockLightLimit,  Skybox? skybox,  CardinalLight? cardinalLight,  String? defaultClock,  List<DimensionAttributeDto> attributes,  List<DimensionTimelineDto> timelines,  DateTime? creationDate,  DateTime? modificationDate)  $default,) {final _that = this;
switch (_that) {
case _DimensionTypeModel():
return $default(_that.uiName,_that.id,_that.projectId,_that.key,_that.hasFixedTime,_that.hasSkylight,_that.hasCeiling,_that.hasEnderDragonFight,_that.coordinateScale,_that.minY,_that.height,_that.logicalHeight,_that.infiniburn,_that.ambientLight,_that.monsterSpawnLightLevel,_that.monsterSpawnBlockLightLimit,_that.skybox,_that.cardinalLight,_that.defaultClock,_that.attributes,_that.timelines,_that.creationDate,_that.modificationDate);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String uiName,  String? id,  String? projectId,  String? key,  bool hasFixedTime,  bool hasSkylight,  bool hasCeiling,  bool hasEnderDragonFight,  double? coordinateScale,  int? minY,  int? height,  int? logicalHeight,  String? infiniburn,  double? ambientLight,  String? monsterSpawnLightLevel,  int? monsterSpawnBlockLightLimit,  Skybox? skybox,  CardinalLight? cardinalLight,  String? defaultClock,  List<DimensionAttributeDto> attributes,  List<DimensionTimelineDto> timelines,  DateTime? creationDate,  DateTime? modificationDate)?  $default,) {final _that = this;
switch (_that) {
case _DimensionTypeModel() when $default != null:
return $default(_that.uiName,_that.id,_that.projectId,_that.key,_that.hasFixedTime,_that.hasSkylight,_that.hasCeiling,_that.hasEnderDragonFight,_that.coordinateScale,_that.minY,_that.height,_that.logicalHeight,_that.infiniburn,_that.ambientLight,_that.monsterSpawnLightLevel,_that.monsterSpawnBlockLightLimit,_that.skybox,_that.cardinalLight,_that.defaultClock,_that.attributes,_that.timelines,_that.creationDate,_that.modificationDate);case _:
  return null;
...
class _DimensionTypeModel extends DimensionTypeModel {
  const _DimensionTypeModel({required this.uiName, this.id, this.projectId, this.key, this.hasFixedTime = false, this.hasSkylight = true, this.hasCeiling = false, this.hasEnderDragonFight = false, this.coordinateScale, this.minY, this.height, this.logicalHeight, this.infiniburn, this.ambientLight, this.monsterSpawnLightLevel, this.monsterSpawnBlockLightLimit, this.skybox, this.cardinalLight, this.defaultClock,  List<DimensionAttributeDto> attributes = const <DimensionAttributeDto>[],  List<DimensionTimelineDto> timelines = const <DimensionTimelineDto>[], this.creationDate, this.modificationDate}): _attributes = attributes,_timelines = timelines,super._();
...
/// Create a copy of DimensionTypeModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? uiName = null,Object? id = freezed,Object? projectId = freezed,Object? key = freezed,Object? hasFixedTime = null,Object? hasSkylight = null,Object? hasCeiling = null,Object? hasEnderDragonFight = null,Object? coordinateScale = freezed,Object? minY = freezed,Object? height = freezed,Object? logicalHeight = freezed,Object? infiniburn = freezed,Object? ambientLight = freezed,Object? monsterSpawnLightLevel = freezed,Object? monsterSpawnBlockLightLimit = freezed,Object? skybox = freezed,Object? cardinalLight = freezed,Object? defaultClock = freezed,Object? attributes = null,Object? timelines = null,Object? creationDate = freezed,Object? modificationDate = freezed,}) {
